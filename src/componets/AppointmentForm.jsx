  ...
  const handleAppointment = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.post(
        "https://medicare-r4rk.onrender.com/api/v1/appointment/post",
        {
          firstName,
          lastName,
          email,
          ...
          department,
          docter_firstName: doctorFirstName,
          docter_lastName: doctorLastName,
        ...
        <form onSubmit={handleAppointment}>
          ...
          <div>
            ...
            >
              ...
              {doctors
                .filter((doctor) => doctor.docterDepartment === department)
                .map((doctor, index) => (
                  <option
